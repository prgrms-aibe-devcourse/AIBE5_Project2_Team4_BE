...
public record FreelancerProfileUpsertRequest(
        @Size(max = 4000, message = "careerDescription must be 4000 characters or fewer")
        ...
        Set<@Size(max = 40, message = "activityRegionCode must be 40 characters or fewer") String> activityRegionCodes,

        @Size(max = 20, message = "availableTimeSlotCodes must contain 20 items or fewer")
        Set<@Size(max = 60, message = "availableTimeSlotCode must be 60 characters or fewer") String> availableTimeSlotCodes,

        @Size(max = 20, message = "projectTypeCodes must contain 20 items or fewer")
        Set<@Size(max = 60, message = "projectTypeCode must be 60 characters or fewer") String> projectTypeCodes
) {
}
